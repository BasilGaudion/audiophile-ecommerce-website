...
export const createHTMLArtifact = (jobs) => {
    ...
    let output = htmlTemplates.replace(INITIAL_DATA_PATTERN, `window.__INITIAL_DATA__ = ${JSON.stringify(initialDataJobs)}`);
